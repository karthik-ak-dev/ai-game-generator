"""
Chat Controller for Core AI Game Generation
Handles business logic for chat and conversation operations in the game modification workflow.
"""
...
class ChatController:
    """
    Core controller for chat operations.
    Handles conversation and game modification business logic.
    """
    ...
    async def process_chat_message(self, request: ChatRequest):
        """
        Process chat messages for game modifications.
    ...
    async def reset_conversation(self, session_id: str):
        """
        Reset conversation context while preserving game state.
